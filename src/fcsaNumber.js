    ...
    fcsaNumberModule
        .directive('fcsaNumber', [
            ...
            function (fcsaNumberConfig, fcsaHelper) {
                var defaultOptions, getOptions, isNumber, isNotDigit, controlKeys, isNotControlKey, hasMultipleDecimals,
                    makeFormatWithMaxDecimals, makeMaxNumber, makeMinNumber, makeMaxDigits, makeIsValid,
                    addCommasToInteger;
                ...
                makeIsValid = function (options) {
                    var validations;
                    validations = [];
                    validations.push(makeFormatWithMaxDecimals(options.maxDecimals ? options.maxDecimals : 0));
                    if (options.max != null) {
                ...
                return {
                    ...
                    link: function (scope, elem, attrs, ngModelCtrl) {
                        ...
                        if (options.renderOnKeyup) {
                            elem.on('keyup', renderOriginal);
                        }

                        elem.on('blur', renderOriginal);
